...
<!--<![endif]-->
<head>
	<script type="text/javascript" src="//use.typekit.net/rry6puv.js"></script>
...
<?php } else if( $blog_id == '3' ) { ?>
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo get_template_directory_uri(); ?>/css/oneifbyland.css" />
